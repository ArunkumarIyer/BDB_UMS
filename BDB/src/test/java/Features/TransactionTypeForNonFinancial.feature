Feature: select transaction type in user Limit for Non Financial

Scenario Outline:To verify whether user is able to select transaction type in user Limit for Non Financial
	...
	Examples: 
		...
		|TGHALI    | ChangePwd@123 |  corp1374   | Automation |   Business  |  116878 |      BHD       |             Maker          |   All Financial    |   1000    |        Yes      |         1000      |          1000          |	       Checker               |         5         |       100         |          100        |           100           |  CHEQUE BOOK REQUEST     |   1     |          No        |       CL1    | okay |   STAQI  |ChangePwd@123|CUSTOMER USER|   cortpm1277   |   Sonali   |  Bamane   |    Bahrain       |     973        |  12345678  |makter2723@gmail.com|   croptc2123    |corpct12@gmail.com |
