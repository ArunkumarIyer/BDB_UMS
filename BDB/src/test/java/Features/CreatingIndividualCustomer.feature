  ...
  Scenario Outline: Creating individual customer
   ...
   #Maker User creation process
    ...
    Examples: 
      ...
      | TGHALI     | ChangePwd@123 | STAQI       | ChangePwd@123 | pro1210            | Automation  | Retail        | 121578 | RETAIL USER | OK     | CUSTOMER USER | hussain2    | Akshay     | Bhamare   | Bahrain        | 973          | 21345679   | shantanu.mondal@aqmtechnologies.com|
