Feature: select Customer Admin in User Category 

Scenario Outline: To verify whether user is able to select Customer Admin in User Category for creating user.
...
Examples: 
		|Username_m|   Password_m |Customer_name |Description|Customer_type|  Cif_no  |Curreny_Dropdown|Maker_Authorization_Dropdown|Transaction_Dropdown|Upper_Limit|Override_Dropdown|Maker_per_Day_Limit|Maker_Future_Transaction|Checker_Authorization_Dropdown|Checker_lower_Limit|Checker_Upper_Limit|Checker_Per_Day_Limit|Checker_Future_Transaction|Auth_Transaction_Dropdown|Approvals|Repeat_Flag_DropDown|      level_DropDown   |Remark|Username_c |Password_c   |User_Category |maker_login_ID  |First_Name|Last_Name|Country_DropDown|Number_Country|Phone_Number|  maker_email_ID     |Checker_login_ID  | checker_email_ID   |  User_option |Minimum_transaction|Maximum_transaction|                    
		| TGHALI   | ChangePwd@123|    adm124    | Automation|   Business  |  118624  |      BHD       |             Maker          |   All Financial    |   1000    |        Yes      |         1000      |          1000          |	       Checker               |         5         |       100         |          100        |           100            |       All Financial     |   1     |          No        |CL1 ( 5.000 -  100.000)|okay  |   STAQI   |ChangePwd@123|CUSTOMER ADMIN|   copms8128    |   Sonali |  Bamane |    Bahrain     |     973      |  12345678  |maks28973@gmail.com  |    crps78238     |corcs1989@gmail.com |CUSTOMER ADMIN|          5        |          100      |
